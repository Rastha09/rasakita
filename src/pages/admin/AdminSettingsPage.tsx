    ...
    <AdminLayout>
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Atur metode pembayaran dan pengiriman</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Pelanggan bayar saat menerima pesanan
                  </p>
                </div>
                <Switch
                  id="cod"
          ...
          <Card>
            <CardHeader className="pb-3">
              ...
              <CardDescription>
                Atur opsi pengiriman dan biaya ongkir
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Pesanan diantar ke alamat pelanggan
                  </p>
                </div>
                <Switch
                  id="courier"
                  checked={courierEnabled}
                  onCheckedChange={setCourierEnabled}
                />
              </div>
              ...
              {courierEnabled && (
                <div className="pl-4 border-l-2 border-primary/20 space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Biaya ongkir flat untuk semua pengiriman
                  </p>
                </div>
              )}
              ...
              <div className="border-t pt-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Pelanggan mengambil pesanan langsung
                    </p>
                  </div>
                  <Switch
                    id="pickup"
            ...
            <Card>
              ...
              <CardContent>
                <Textarea
                  ...
                  placeholder="Alamat lengkap untuk pengambilan pesanan..."
                  rows={3}
                />
                <p className="text-xs text-muted-foreground mt-2">
                  Alamat ini akan ditampilkan ke pelanggan saat memilih ambil di tempat
                </p>
              </CardContent>
            </Card>
          )}
